import styles from "./DiscordCorner.module.css";

export default function DiscordCorner() {
    return (
        <div className={styles.discordCornerWrapper}>
            <svg
                color="#181213"
                fill="#E8EDDF"
                width="100"
            ...
            >
                <g>
                    <a href="https://nntin.github.io/discord-logo">
                        <path d="M0,0 L0,250 L250,0 Z" fill="#E8EDDF"></path>
                    </a>
                </g>
                <g className={styles.discordCorner}>
                    <svg
                        color="#181213"
                        fill="#E8EDDF"
                        width="120"
                        height="120"
                        viewBox="0 0 48 48"
                        className={styles.discordLogoContainer}
                    >
                            ...
                            <g>
                                ...
                                <g id="discordFaceID72">
                                    ...
                                    <g id="discord-logo-eyes">
                                        ...
                                        <g className={styles.discordEyes}>
                                            <use xlinkHref="#discord-def-face-eyes"></use>
                                        </g>
                                    </g>
                                </g>
                        ...
                        <g className={`${styles.discordLogo} ${styles.swirlAnimation}`}>
                            <use className={styles.discordOriginal} xlinkHref="#discordFaceID72"></use>
                            <use
                                className={styles.discordInnerLayer}
                                xlinkHref="#discordFaceID72"
                                mask="url(#mask-inner-layer)"
                            ></use>
                            <use
                                className={styles.discordMiddleLayer}
                                xlinkHref="#discordFaceID72"
                                mask="url(#mask-middle-layer)"
                            ></use>
                            <use
                                className={styles.discordOuterLayer}
                                xlinkHref="#discordFaceID72"
